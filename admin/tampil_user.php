...
<?php
 ...
 switch($status):
   case 'sukses-baru':
     $msg = 'Data User baru berhasil ditambahkan';
     break;
   case 'sukses-hapus':
     $msg = 'Data User behasil dihapus';
     break;
   case 'sukses-edit':
     $msg = 'Data User behasil diedit';
     break;
 endswitch;
...
<script>
    ...
    return confirm_edit;
     ...
     function cari() {
      ...
      table = document.getElementById("tampil_user");
           ...
           <div class="table-responsive">
            <div class="col-sm-12 col-md-6">
              ...
              <div id="dataTable_filter" class="dataTables_filter">
                <label>
                  <input type="text" id="cari" onkeyup="cari()" placeholder="Cari User" >
                </label>
              </div>
            </div>
              <table class="table table-bordered" id="tampil_user" width="100%" cellspacing="0">
                <thead>
                  <tr>
                    <th>Username</th>
                    <th>Password</th>
                ...
                <?php  ?>
                      ...
                      <td>
                        <a href="edit_user.php?username=<?php echo $d['username']; ?>" onclick=" return edit()">
                         <center><img src="pictures/edit.png" width="20px" height="20px"></center>
                        </a>
                      </td>
                      <td>
                        <a href="hapus_user.php?username=<?php echo $d['username']; ?>" onclick=" return hapus()">
