...
<?php
 ...
 switch($status):
   case 'sukses-baru':
     $msg = 'Data Kelurahan baru berhasil ditambahkan';
     break;
   case 'sukses-hapus':
     $msg = 'Data Kelurahan behasil dihapus';
     break;
   case 'sukses-edit':
     $msg = 'Data Kelurahan behasil diedit';
     break;
 endswitch;
...
<script>
    ...
    return confirm_edit;
     ...
     function cari() {
      ...
      table = document.getElementById("tampil_kelurahan");
           ...
           <div class="table-responsive">
            <div class="col-sm-12 col-md-6">
              <div id="dataTable_filter" class="dataTables_filter">
                ...
                <label>
                  <input type="text" id="cari" onkeyup="cari()" placeholder="Cari Kelurahan" >
                </label>
              </div>
            </div>
              <table class="table table-bordered" id="tampil_kelurahan" width="100%" cellspacing="0">
                ...
                <?php  ?>
                      ...
                      <td>
                        <a href="edit_kelurahan.php?id_kelurahan=<?php echo $d['id_kelurahan']; ?>" onclick=" return edit()">
                         <center><img src="pictures/edit.png" width="20px" height="20px"></center>
                        </a>
                      </td>
                      <td>
                        <a href="hapus_kelurahan.php?id_kelurahan=<?php echo $d['id_kelurahan']; ?>" onclick=" return hapus()">
