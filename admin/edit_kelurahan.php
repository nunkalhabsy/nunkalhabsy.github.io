...
if(!$id_kelurahan) {
  ...
  $query = $pdo->prepare('SELECT * FROM data_kelurahan WHERE data_kelurahan.id_kelurahan = :id_kelurahan');
  ...
  $nama_kelurahan = (isset($result['nama_kelurahan'])) ? trim($result['nama_kelurahan']) : '';
  $jumlah_penduduk = (isset($result['jumlah_penduduk'])) ? trim($result['jumlah_penduduk']) : '';
  $jumlah_penderita_dbd = (isset($result['jumlah_penderita_dbd'])) ? trim($result['jumlah_penderita_dbd']) : '';
...
if(isset($_POST['submit'])):  
  ...
  if(!$jumlah_penderita_dbd) {
    $errors[] = 'Jumlah Penderita DBD Kelurahan tidak boleh kosong';
  }
  ...
  if(empty($errors)):
    ...
    $prepare_query = 'UPDATE data_kelurahan SET nama_kelurahan = :nama_kelurahan, jumlah_penduduk = :jumlah_penduduk, jumlah_penderita_dbd = :jumlah_penderita_dbd WHERE id_kelurahan = :id_kelurahan';
    $data = array(
    ...
    redirect_to('tampil_kelurahan.php?status=sukses-edit');
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="">
                      ...
                      <?php else: ?>      
                <center>
                <form action="edit_kelurahan.php?id_kelurahan=<?php echo $id_kelurahan; ?>" method="post">
                  <div style="overflow-x:auto;">
                  <div class="table-responsive">  
                  <table>
                    <tr>
                      <td><label>ID Kelurahan</label></td>
                      <td><input type="text" name="id_kelurahan" value="<?php echo $id_kelurahan; ?>" disabled></td>
                    </tr>
                    <tr>
