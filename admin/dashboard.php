          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-warning o-hidden h-100">
              <div class="card-body">
                ...
                $kelurahans = $query->fetchAll();
               
                  ?>
                <div class="mr-5"><?php echo count($kelurahans); ?> Data Kelurahan</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="tampil_kelurahan.php">
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-warning o-hidden h-100">
              <div class="card-body">
                ...
                $cluster = $query2->fetchAll();
               
                  ?>
                <div class="mr-5"><?php echo count($cluster); ?> Data Cluster</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="tampil_cluster.php">
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-warning o-hidden h-100">
              <div class="card-body">
                ...
                <?php
                $query3 = $pdo->prepare('SELECT * FROM centroid');
                $query3->execute();     
                $query3->setFetchMode(PDO::FETCH_ASSOC);
                $centroid = $query3->fetchAll();
               
                  ?>
                <div class="mr-5"><?php echo count($centroid); ?> Data Centroid</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="tampil_centroid.php">
                <span class="float-left">Lihat Selengkapnya</span>
                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
