...
<?php
 ...
 switch($status):
   case 'sukses-baru':
     $msg = 'Data Centroid baru berhasil ditambahkan';
     break;
   case 'sukses-hapus':
     $msg = 'Data Centroid behasil dihapus';
     break;
   case 'sukses-edit':
     $msg = 'Data Centroid behasil diedit';
     break;
 endswitch;
           ...
           <div class="table-responsive">
            <div class="col-sm-12 col-md-6">
              <div id="dataTable_filter" class="dataTables_filter">
                <h3>Data Centroid</h3>
                <label>
                  <input type="text" id="cari" onkeyup="cari()" placeholder="Cari Centroid" >
                </label>
              </div>
            </div>
              <table class="table table-bordered" id="tampil_cluster" width="100%" cellspacing="0">
                <thead>
                  <tr>
                    <th>ID Centroid</th>
                ...
                <?php
                $query = $pdo->prepare('SELECT centroid.id_centroid, data_kelurahan.nama_kelurahan, cluster.cluster,
                ...
                ?>
                    ...
                    <tr>
                <?php  ?>
                      <td><?php echo $d['id_centroid']; ?></td>
                      <td><?php echo $d['nama_kelurahan']; ?></td>
                      <td><?php echo $d['cluster']; ?></td>
                      <td><?php echo $d['c1']; ?></td>
                      <td><?php echo $d['c2']; ?></td>
                      <td>
                        <a href="edit_centroid.php?id_centroid=<?php echo $d['id_centroid']; ?>" onclick=" return edit()">
                         <center><img src="pictures/edit.png" width="20px" height="20px"></center>
                        </a>
                      </td>
                      <td>
                        <a href="hapus_centroid.php?id_centroid=<?php echo $d['id_centroid']; ?>" onclick=" return hapus()">
                         <center><img src="pictures/hapus.png" width="20px" height="20px"></center>
                        </a>
                      </td>
                    </tr>
                  </tbody>
